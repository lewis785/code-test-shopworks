...
final class Version20200304195959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE staff (id INT AUTO_INCREMENT NOT NULL, shop_id INT DEFAULT NULL, first_name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, INDEX IDX_426EF3924D16C4DD (shop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
