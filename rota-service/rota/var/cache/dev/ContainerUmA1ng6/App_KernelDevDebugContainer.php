...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\RotaController' => 'getRotaControllerService',
    ...
    /**
     * Gets the public 'App\Controller\RotaController' shared autowired service.
     *
     * @return \App\Controller\RotaController
     */
    protected function getRotaControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/RotaController.php';

        $this->services['App\\Controller\\RotaController'] = $instance = new \App\Controller\RotaController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'session' => '?',
            'twig' => '?',
        ]))->withContext('App\\Controller\\RotaController', $this));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\RotaRepository' => ['privates', 'App\\Repository\\RotaRepository', 'getRotaRepositoryService', false],
            'App\\Repository\\ShiftBreakRepository' => ['privates', 'App\\Repository\\ShiftBreakRepository', 'getShiftBreakRepositoryService', false],
            'App\\Repository\\ShiftRepository' => ['privates', 'App\\Repository\\ShiftRepository', 'getShiftRepositoryService', false],
            'App\\Repository\\ShopsRepository' => ['privates', 'App\\Repository\\ShopsRepository', 'getShopsRepositoryService', false],
            'App\\Repository\\StaffRepository' => ['privates', 'App\\Repository\\StaffRepository', 'getStaffRepositoryService', false],
        ], [
            'App\\Repository\\RotaRepository' => '?',
            'App\\Repository\\ShiftBreakRepository' => '?',
            'App\\Repository\\ShiftRepository' => '?',
            'App\\Repository\\ShopsRepository' => '?',
    ...
    /**
     * Gets the private 'App\Repository\RotaRepository' shared autowired service.
     *
     * @return \App\Repository\RotaRepository
     */
    protected function getRotaRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/RotaRepository.php';

        return $this->privates['App\\Repository\\RotaRepository'] = new \App\Repository\RotaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\ShiftBreakRepository' shared autowired service.
     *
     * @return \App\Repository\ShiftBreakRepository
     */
    protected function getShiftBreakRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ShiftBreakRepository.php';

        return $this->privates['App\\Repository\\ShiftBreakRepository'] = new \App\Repository\ShiftBreakRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
     ...
     */
    protected function getShiftRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ShiftRepository.php';

        return $this->privates['App\\Repository\\ShiftRepository'] = new \App\Repository\ShiftRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\ShopsRepository' shared autowired service.
     *
     * @return \App\Repository\ShopsRepository
     */
    protected function getShopsRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ShopsRepository.php';

        return $this->privates['App\\Repository\\ShopsRepository'] = new \App\Repository\ShopsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
     ...
     */
    protected function getStaffRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        ...
        return $this->privates['App\\Repository\\StaffRepository'] = new \App\Repository\StaffRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
